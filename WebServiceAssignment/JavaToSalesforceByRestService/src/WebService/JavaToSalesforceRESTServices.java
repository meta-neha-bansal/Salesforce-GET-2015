...
public class JavaToSalesforceRESTServices {
	...
	static final String USERNAME = "neha.bansal@salesforce.com";
	static final String PASSWORD = "neha12345";
	static final String LOGINURL = "https://login.salesforce.com";
	static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
	static final String CLIENTID = "3MVG9ZL0ppGP5UrCyj9M3GW0KTlVTpmqIbfmsMsDs1oVce.qP7J6n36_4O9nb2FYBaaK_SAk14zsJyx3bAlQz";
	static final String CLIENTSECRET = "5533518375107840631";
	...
	public static void createStudent() {
		...
		try {
			...
			switch (choice) {
			case 1:
				classId = "a08280000079BBy";
				break;
			case 2:
				classId = "a08280000079BBt";
				break;
			case 3:
				classId = "a08280000079BC3";
				break;
			default:
				classId = "a08280000079BBy";
				break;
